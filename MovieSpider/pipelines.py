...
class MoviespiderPipeline(object):
    def __init__(self):
        self.conn = pymysql.connect(host='127.0.0.1', port=3306, user='root', passwd='1234', db='movie',
                                    charset='utf8')
    ...
    def process_item(self, item, spider):
        ...
        self.cursor.execute(movie_sql, (
            item['name'], item['title'], item['aka'], item['origin_url'], item['cover'], item['directors'],
